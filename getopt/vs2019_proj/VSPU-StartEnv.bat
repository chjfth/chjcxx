...
REM -- example: D:\gitw\chjcxx\getopt\libsrc\include

call :SetEnvVar vsps_p_list_CHEADERS=getopt
REM -- This refers to the subdirectory: D:\gitw\chjcxx\getopt\libsrc\include\getopt
