...
int CircBufws_MoveData(CCircBufws &src, CCircBufws &dst, int bytesToCopy=-1); // -1 means copy most bytes
...
int 
CircBufws_MoveData(CCircBufws &src, CCircBufws &dst, int reqCopy)
{
	if(reqCopy==0)
		return 0;
