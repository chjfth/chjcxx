...
MakeDelega_CleanupPtr(Cec_free_pVoid, void, free_void_ptr, void*)
...
MakeDelega_CleanupPtr(Cec_free_pchar, void, free_char_ptr, char*)

inline void free_unsigned_char_ptr(unsigned char * p){ free(p); }
MakeDelega_CleanupPtr(Cec_free_pUchar, void, free_unsigned_char_ptr, unsigned char *)
...
MakeDelega_CleanupPtr(Cec_delete_pchar, void, _cpp_delete_pchar, char*)

inline void _cpp_delete_pUchar(unsigned char *pUchar) { delete []pUchar; }
MakeDelega_CleanupPtr(Cec_delete_pUchar, void, _cpp_delete_pUchar, unsigned char*)

inline void _cpp_delete_pwchar(wchar_t *pwchar){ delete []pwchar; }
MakeDelega_CleanupPtr(Cec_delete_pwchar, void, _cpp_delete_pwchar, wchar_t*)
...
MakeDelega_CleanupPtr(Cec_delete_int, void, _cpp_delete_int_array, int*)

inline void _cpp_delete_uint_array(unsigned int *p){ delete []p; }
MakeDelega_CleanupPtr(Cec_delete_uint, void, _cpp_delete_uint_array, unsigned int*)



// For `` FILE* ''
inline int fclose_FILE_ptr(FILE *fp){ return fclose(fp); } // wrapper for __stdcall compiler env
MakeDelega_CleanupPtr(Cec_fclose, int, fclose_FILE_ptr, FILE*)
